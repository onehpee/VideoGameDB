...
//            VideoGameServiceExample videoGameServiceExample = new VideoGameServiceExample(new RealVideoGameDAOImp());
//            VideoGame game =  videoGameServiceExample.getVideoGameByTitle("");
//            System.out.println(game);
//            VideoGame newVideoGame = new VideoGame(1, "Super Mario World", "E", 40.00, LocalDate.now(), "Nintendo Switch");
//
//            new VideoGameService().addNewGame(newVideoGame);
